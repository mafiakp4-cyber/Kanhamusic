...
# 🔑 Config (Tera BOT_TOKEN laga diya)
API_ID = 21302239
...
async def song_downloader(client, message: Message):
    ...
    try:
        ...
        if 'file_path' not in result or not os.path.exists(result['file_path']):
            await status.edit_text("❌ Error: File not found after download.")
            return
